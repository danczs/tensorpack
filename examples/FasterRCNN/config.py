...
# dataset -----------------------
_C.DATA.BASEDIR = '/data/newczs/WIDER'
...
_C.DATA.CLASS_NAMES = ['none','face']  # NUM_CLASS (NUM_CATEGORY+1) strings, to be populated later by data loader. The first is BG.
...
_C.TRAIN.LR_SCHEDULE = [7000, 10000]    # "2x" schedule in detectron
...
_C.TEST.RESULT_SCORE_THRESH_VIS = 0.2#0.3   # only visualize confident results
_C.TEST.RESULTS_PER_IM = 2000
