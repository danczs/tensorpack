...
import copy
import itertools
from widerdata import WiderData
...
def get_train_dataflow():
    ...
    imgs = WiderData(cfg.DATA.BASEDIR).loadImgs(data='train',fromfile=True)
...
def get_eval_dataflow(shard=0, num_shards=1):
    ...
    imgs = WiderData(cfg.DATA.BASEDIR).loadImgs(data='val',fromfile=True)
